...
(defun strk/get-random-prompt ()
  "Return a random prompt from `strk/freewrite-prompts'."
  (nth (random (length strk/freewrite-prompts)) strk/freewrite-prompts))

(defun strk/freewrite ()
...
(global-set-key (kbd "C-c f") 'strk/freewrite)
#+end_src
